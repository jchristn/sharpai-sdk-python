...
class BaseClient:
    """
    SharpAI SDK base client class.
    Note: SharpAI SDK does not require authentication tokens, tenant GUID, or graph GUID.
    """
    ...
    def _get_headers(self):
        ...
        Note: SharpAI SDK does not require authentication tokens/keys.
        """
