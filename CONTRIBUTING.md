...
Welcome to `sharpai-sdk-python` contributor's guide.
...
If you experience bugs or general issues with `sharpai-sdk-python`, please have a look
...
You can help improve `sharpai-sdk-python` docs by making them more readable and coherent, or
by adding missing information and correcting mistakes.

`sharpai-sdk-python` documentation uses [Sphinx] as its main documentation compiler.
...
```{todo} If your project is hosted on GitHub, you can also mention the following tip:
   ...
   :::{tip}
      ...
      propose changes in `sharpai-sdk-python`'s files. While this mechanism can
...
```
conda create -n sharpai-sdk-python python=3 six virtualenv pytest pytest-cov
conda activate sharpai-sdk-python
```
...
3. Clone this copy to your local disk:
   ...
   ```
   git clone git@github.com:YourLogin/sharpai-sdk-python.git
...
5. Install [pre-commit]:
   ...
   `sharpai-sdk-python` comes with a lot of hooks configured to automatically help the
...
[repository]: https://github.com/<USERNAME>/sharpai-sdk-python
[issue tracker]: https://github.com/<USERNAME>/sharpai-sdk-python/issues
